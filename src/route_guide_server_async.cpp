...
private:
    ...
    void Done() override
    {
        ...
        a = --gUnaryRpcCounter;
        gpr_log(GPR_DEBUG, "Pending Unary Rpcs Count = %d", a);
    }
...
private:
    ...
    void Done() override
    {
        ...
        a = --gServerStreamingRpcCounter;
        gpr_log(GPR_DEBUG, "Pending Server Streaming Rpcs Count = %d", a);
    }
...
private:
    ...
    void Done() override
    {
        ...
        a = --gClientStreamingRpcCounter;
        gpr_log(GPR_DEBUG, "Pending Client Streaming Rpcs Count = %d", a);
    }
...
private:
    ...
    void Done() override
    {
        ...
        a = --gBidirectionalStreamingRpcCounter;
