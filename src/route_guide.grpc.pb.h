 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    //
    // Obtains the Features avaiable within the given Rectangle. Results are
    ...
    // while receiving other RouteNotes(eg. from other users).
  ...
  class ExperimentalWithCallbackMethod_GetFeature : public BaseClass {
   ...
   public:
    ...
    void SetMessageAllocatorFor_GetFeature(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::routeguide::Point, ::routeguide::Feature>*>(
